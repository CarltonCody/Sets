...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        //Changing font to custom font for the nav bar title
        let navigation = UINavigationBar.appearance()
        
        let navigationFont = UIFont(name: "VarelaRound-Regular", size: 20)
        let navigationLargeFont = UIFont(name: "VarelaRound-Regular", size: 34)
        ...
        if #available(iOS 11, *){ //Checking to see if the large text is available for older versions
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "SetsDataModel")
